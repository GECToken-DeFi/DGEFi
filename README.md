...
For example, now the total amount of the DGE tokens is 110W in the pool, and the net value of DGE is from 1 NV= 1.3 CNY, and after 12 hours of market operation, its net value dropped to 1 NV= 0.91 CNY, then the rebase mechanism is triggered also, that is, the total market supply is reduced by 10%. That is to say, from 110W DGE tokens reduce 11W DGE tokens, the total supply dropped to 990,000 DGE tokens. This is, due to the decrease of supply, its intrinsic value has increased.
