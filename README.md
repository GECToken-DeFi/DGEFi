...
With the continuous thickening of the real assets in sustainable operation, the more cash "ores" in the bonus pool are, which also encourages more users to participate and provides liquidity for DGE, the more digital assets are locked. Then the thicker the underlying digital assets of GBank, the higher the net value of DGE, and the better its liquidity will be.
