...
contract Authority is Owned {
    ...
    */
    ...
    //开关锁
    bool ownersLock_open = true;
    bool govenors1_open = true;
    bool govenors2_open = true;
    bool govenors3_open = true;
    bool govenors4_open = true;
    ...
    modifier onlyGovenors1() {
        require((govenors1[msg.sender]) && (govenors1_open == true) && (ownersLock_open == true), 'msg.sender no righte of govenors1');
        _; //do something
    }
    modifier onlyGovenors2() {
        require((govenors2[msg.sender]) && (govenors2_open == true) && (ownersLock_open == true), 'msg.sender no righte of govenors2');
        _; //do something
    }
    modifier onlyGovenors3() {
        require((govenors3[msg.sender]) && (govenors3_open == true) && (ownersLock_open == true), 'msg.sender no righte of govenors3');
        _; //do something
    }
    modifier onlyGovenors4() {
        require((govenors4[msg.sender]) && (govenors4_open == true) && (ownersLock_open == true), 'msg.sender no righte of govenors4');
        _; //do something
    }
    //get lock open flage
    function getOwnersLock_open() public view returns(bool _open) {
        return ownersLock_open;
    }
    function getGovenors1_open() public view returns(bool _open) {
        return govenors1_open;
    }
    function getGovenors2_open() public view returns(bool _open) {
        return govenors2_open;
    }
    function getGovenors3_open() public view returns(bool _open) {
        return govenors3_open;
    }
    function getGovenors4_open() public view returns(bool _open) {
    ...
    //getgovenors
    function getGovenors1(address _user) public view returns(bool _open) {
        return govenors1[_user];
    }
    function getGovenors2(address _user) public view returns(bool _open) {
        return govenors2[_user];
    }
    function getGovenors3(address _user) public view returns(bool _open) {
        return govenors3[_user];
    }
    function getGovenors4(address _user) public view returns(bool _open) {
